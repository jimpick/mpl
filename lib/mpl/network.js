...
var Network = function (_EventEmitter) {
  ...
  function Network(docSet) {
    ...
    var downloadQueue = new _pQueue2.default({ concurrency: 1 });
    return _this;
  }
  ...
  _createClass(Network, [{
        ...
        (0, _datNode2.default)('./not-used', options, function (err, dat) {
          ...
          historyStream.on('data', function (data) {
            ...
            if (match) {
              ...
              downloadQueue.add(_this3.downloadAndReceiveMessage(data));
              _this3.downloadAndRecieveMessage(data);
            }
          });
        });
      };
    ...
    value: function downloadAndReceiveMessage(data) {
      ...
      if (!this.Peers[peer]) {
        this.Peers[peer] = new _automerge2.default.Connection(this.docSet, function (msg) {
          ...
          if (_this4.dat) {
            ...
            var nextVersion = lastVersion ? lastVersion + 1 : _this4.dat.archive.version;
